...
describe 'GET Object' do
  ...
  describe "request headers" do
    context "given Range header within content-length" do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_RANGE" => "bytes=0-2"
      end
    ...
    context "Range header syntax does not follow" do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_RANGE" => "1-3"
      end
    ...
    context "given start position out of range for Range header" do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_RANGE" => "bytes=4-10"
      end
    ...
    context "given end position out of range for Range header" do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_RANGE" => "bytes=3-10"
      end
    ...
    context 'given If-Modified-Since earlier than last-modified' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_MODIFIED_SINCE" => "Wed, 13 Jul 2011 19:14:36 GMT"
      end
    ...
    context 'given If-Modified-Since equal to last-modified' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_MODIFIED_SINCE" => "Thu, 21 Jul 2011 19:14:36 GMT"
      end
    ...
    context 'given If-Modified-Since header later than last-modified' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_MODIFIED_SINCE" => "Wed, 27 Jul 2011 19:14:36 GMT"
      end
    ...
    context 'given If-Unmodified-Since earlier than last-modified' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_UNMODIFIED_SINCE" => "Wed, 13 Jul 2011 19:14:36 GMT"
      end
    ...
    context 'given If-Unmodified-Since equal to last-modified' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_UNMODIFIED_SINCE" => "Thu, 21 Jul 2011 19:14:36 GMT"
      end
    ...
    context 'given If-Unmodified-Since header later than last-modified' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_UNMODIFIED_SINCE" => "Wed, 27 Jul 2011 19:14:36 GMT"
      end
    ...
    context 'given If-Match header equal to ETag' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_MATCH" => "ea703e7aa1efda0064eaa507d9e8ab7e"
      end
    ...
    context 'given If-Match header not equal to ETag' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_MATCH" => "02ccdb34c1f7a8c84b72e003ddd77173"
      end
    ...
    context 'given If-None-Match header not equal to ETag' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_NONE_MATCH" => "02ccdb34c1f7a8c84b72e003ddd77173"
      end
    ...
    context 'given If-None-Match header equal to ETag' do
      before(:all) do
        get "/castoro/foo/bar/baz.txt", {}, "HTTP_IF_NONE_MATCH" => "ea703e7aa1efda0064eaa507d9e8ab7e"
      end
